"""
Django settings for world_of_games project.
...
SECRET_KEY = 'django-insecure-(@-$f*d*p_u1cg%n=0g8k*i^hrw2zd)8$3t-9pxy27)f5+7i64'
...
ROOT_URLCONF = 'world_of_games.urls'
...
WSGI_APPLICATION = 'world_of_games.wsgi.application'
